...
function App() {
  ...
  const latex = String.raw`\cssId{var-K}{K} = \frac{1}{2} \cssId{var-m}{m} \cssId{var-v}{v}^2`;
  ...
  const mPos = useLabelPosition(massConfig.id, formulaRef, [m], "above");
  ...
  return (
    <div className="min-h-screen p-8 bg-gray-50 flex flex-col items-center">
      ...
      <p className="text-sm text-gray-500 mt-4">
        Drag <span className="text-blue-600 font-medium">v</span> or <span className="text-blue-600 font-medium">m</span> in the formula to change values
      </p>
    </div>
  );
}
